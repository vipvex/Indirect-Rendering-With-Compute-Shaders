...
Shader "array_test"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform SAMPLER( sampler_TextureArray );


			float4 MyCustomExpression12( float4 array )
			{
				return array;
			}
						...
						)
			{
				...
				float2 uv_TextureArray = packedInput.ase_texcoord5.xy * _TextureArray_ST.xy + _TextureArray_ST.zw;
				float4 texArray11 = SAMPLE_TEXTURE2D_ARRAY(_TextureArray, sampler_TextureArray, uv_TextureArray, _Float0 );
				float4 array12 = texArray11;
				float4 localMyCustomExpression12 = MyCustomExpression12( array12 );
				
				surfaceDescription.Albedo = localMyCustomExpression12.xyz;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_TextureArray = packedInput.ase_texcoord.xy * _TextureArray_ST.xy + _TextureArray_ST.zw;
				float4 texArray11 = SAMPLE_TEXTURE2D_ARRAY(_TextureArray, sampler_TextureArray, uv_TextureArray, _Float0 );
				float4 array12 = texArray11;
				float4 localMyCustomExpression12 = MyCustomExpression12( array12 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_TextureArray = packedInput.ase_texcoord7.xy * _TextureArray_ST.xy + _TextureArray_ST.zw;
				float4 texArray11 = SAMPLE_TEXTURE2D_ARRAY(_TextureArray, sampler_TextureArray, uv_TextureArray, _Float0 );
				float4 array12 = texArray11;
				float4 localMyCustomExpression12 = MyCustomExpression12( array12 );
...
/*ASEBEGIN
Version=18100
0;-1080;1920;1019;1644.219;540.6305;1.085079;True;False
Node;AmplifyShaderEditor.RangedFloatNode;13;-1212.358,-0.2613437;Inherit;False;Property;_Float0;Float 0;1;0;Create;True;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureArrayNode;11;-905.3351,9.501309;Inherit;True;Property;_TextureArray;TextureArray;0;0;Create;True;0;0;False;0;False;Assets/new_animations/soldier/soldier_array.asset;0;Object;-1;Auto;False;7;6;SAMPLER2D;;False;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CustomExpressionNode;12;-449.5469,2.993792;Inherit;False;return array@;4;False;1;True;array;FLOAT4;0,0,0,0;In;;Inherit;False;My Custom Expression;True;False;0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;0,0;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;4;array_test;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-25;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;0
...
ASEEND*/
//CHKSM=ADA975F05E71EED14EEC4F39E6C01E3780366165