...
void setupScale()
{
        ...
        Macro_UNITY_MATRIX_M = VisibleShaderDataBuffer[unity_InstanceID].PositionMatrix;
        unity_WorldToObject = VisibleShaderDataBuffer[unity_InstanceID].InversePositionMatrix;
    #else
        Macro_UNITY_MATRIX_M = IndirectShaderDataBuffer[unity_InstanceID].PositionMatrix;
        ...
        #define transformPosition mul(Macro_UNITY_MATRIX_M, float4(0,0,0,1)).xyz
        ...
        Macro_UNITY_MATRIX_M = mul(Macro_UNITY_MATRIX_M, float4x4(cull, 0, 0, 0, 0, cull, 0, 0, 0, 0, cull, 0, 0, 0, 0, 1));
